...
---
# EquiDexFlow &mdash; Allegro Hand (Full Model Variant)
SE(3)-equivariant flow-matching model for dexterous grasp generation. The checkpoint and config file in this repo are for the `Full` variant of EquiDexFlow.
...
path = hf_hub_download("cenwerem/equidexflow-allegro-full", "checkpoint_best.pt")
